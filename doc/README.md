...
що робить його одним з найдешевших варіантів радіо передачі даних, які є сьогодні на ринку. 
...
Ця нова структура покращила якысть передачы одразу по кількох пунктах. 
